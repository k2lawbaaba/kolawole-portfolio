...
const Skills = () => {
  return (
    <div id="about-me" className="w-full sm:py-12 py-5 px-6  bg-slate-100">
      <h1 className="font-extrabold text-[40px] text-center text-gray-800 mb-8 relative littleLine">
        Skills
      </h1>
      <section className="grid sm:grid-cols-4 grid-cols-3 place-items-center gap-8 sm:px-20 px-6 py-5">
