...
const Skills = () => {
  return (
    <div id="about-me" className="w-full sm:py-12 py-5 px-6 bg-slate-100 text-black dark:bg-black dark:text-white dark:border-b-slate-800 dark:sm:mb-4 dark:border-b-[0.1px]">
